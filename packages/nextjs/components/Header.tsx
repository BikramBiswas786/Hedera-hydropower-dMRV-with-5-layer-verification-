...
export const Header = () => {
  ...
  return (
    <div className="print:hidden sticky lg:static top-0 navbar bg-base-100 min-h-0 shrink-0 justify-between z-20 shadow-sm border-b border-base-300 px-0 sm:px-2">
