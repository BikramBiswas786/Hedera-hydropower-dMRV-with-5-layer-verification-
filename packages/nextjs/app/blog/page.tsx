  ...
  <article className="flex flex-col gap-6 py-8 px-5 lg:px-10 max-w-3xl mx-auto w-full">
    ...
    <section className="flex flex-col gap-3">
      ...
      <ol className="m-0 pl-5 flex flex-col gap-2">
        ...
        <li>
          <Link href="/market">Market</Link> shows Chainlink, Supra, and the SaucerSwap pair the contract swaps. A buy
          is refused when that pair is more than 3% from the oracle. Retirements minted HYRET serial 1 and serial 2.
        </li>
      </ol>
    </section>
