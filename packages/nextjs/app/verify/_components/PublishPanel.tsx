  ...
  return (
    <div className="flex flex-col gap-3 border-t border-base-300 pt-4">
      ...
      <p className="text-sm text-base-content/70 m-0">
        Step 1 publishes the readings and report to HCS and returns the VVB&apos;s EIP-712 approval. Step 2 relays{" "}
        <code>submitAttestation</code> with the meter&apos;s and the VVB&apos;s signatures; the methodology module
        recomputes the emission reductions on-chain. Requires the server&apos;s <code>MRV_API_KEY</code>.
      </p>
