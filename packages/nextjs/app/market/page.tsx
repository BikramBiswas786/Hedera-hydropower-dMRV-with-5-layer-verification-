  ...
  <div className="flex flex-col gap-6 px-5 py-8 max-w-6xl w-full mx-auto">
    <PageHeader title="Credit market">
      <p className="mt-2">
        ...
        to it when Chainlink is unavailable. This page will not build that purchase if the SaucerSwap WHBAR/USDC pool is
        more than 3% away. Retiring burns the HTS tokens and mints an HTS NFT certificate to the buyer.
      </p>
    </PageHeader>
    <Marketplace />
  </div>
