...
4. **Deploy.** `HCS_TOPIC_ID=0.0.10726081 VERIFIER_ADDRESS=… ADMIN_ADDRESS=… yarn deploy --network hederaTestnet`. It
   ...
   until then).
5. **Verify.** `yarn hardhat:verify:testnet` (HashScan/Sourcify), then check the roles:
