...
**Author: Bikram Biswas | Updated: March 24, 2026 | Version: V4.2 — ALL AUDIT FIXES APPLIED**
...
> - Do not conflate preparation with submission. BEE's review timeline begins on the date they receive the document, not when you start writing it.
...
STEP 4 (Month 4 — SUBMIT): Submit PDD to BEE for technical review
  ← 4–6 month review clock starts HERE on submission date (Month 4)
  Expected review timeline: 4–6 months → approval Month 8–10
  Cost: Free
...
HCS Testnet Topic: 0.0.7462776
HTS Testnet Token: 0.0.7964264
⚠️ BEFORE FINAL SUBMISSION: Replace testnet IDs with mainnet IDs from .env.production
...
Drift detection methodology reference:
  Bifet, A. & Gavalda, R. (2007). "Learning from Time-Changing Data with
  Adaptive Windowing." Proceedings of the 2007 SIAM International Conference
  on Data Mining, pp. 443–448.

### SECTION E: MONITORING EVIDENCE
Primary evidence: Hedera HCS topic — publicly accessible on HashScan
  ⚠️ INSERT MAINNET TOPIC ID HERE before BEE submission (testnet: 0.0.7462776)
...
class ShadowModeComparator {
  ...
  async generateVerraReport(plantId, startDate, endDate) {
    ...
    return {
      ...
      methodology:      'ACM0002',
      blockchain:       'Hedera HCS testnet 0.0.7462776 (mainnet ID to be inserted before submission)',
...
• ADWIN algorithm: Bifet, A. & Gavalda, R. (2007). "Learning from Time-Changing
  Data with Adaptive Windowing." SIAM International Conference on Data Mining,
  pp. 443–448. (Not proprietary — peer-reviewed published algorithm)
...
> **NOTE:** Do not cite specific Guardian pull request numbers in regulatory submissions without first verifying them at github.com/hashgraph/guardian and confirming they are merged to main. An unverified PR citation in a Verra submission will be checked by their technical reviewer.
...
// Reference: Bifet & Gavalda (2007), Section 2.1, ε_cut formula
...
class ADWINDetector {
  ...
  _testForDrift() {
    ...
    for (let splitPoint = 1; splitPoint < n - 1; splitPoint++) {
      ...
      // Source: Bifet & Gavalda (2007), pp. 443–448
      const m         = 1 / ((1 / n0) + (1 / n1));
...
> **RECONCILIATION NOTE (FIX #2):** Previous drafts of this document showed three different Month 12 revenue figures in different sections: $83K (headline), $93,240 (line-item sum), and $108,000 (aggressive tier mix). This was an error — all three were projections under different assumptions, not one reconciled number. The single authoritative base target is **$83K ARR**, calculated below using a conservative tier mix. The $108K figure is an upside scenario documented separately; it is not the base case.
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
UPSIDE SCENARIO (aggressive tier mix — NOT the base target):
  20 Basic / 15 Standard / 5 Premium = $9,000/mo = ~$108,000 ARR
  This requires faster upsell conversion and is achievable but not guaranteed.
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
| **4** | shadow-mode-comparator.js + Migration 006 | India CCTS PDD **submitted** to BEE (clock starts Month 4, approval Month 8–10) | $3,700 (3×$1K setup + 7×$100 sub) |
...
*Author: Bikram Biswas | Repo: [BikramBiswas786/Hedera-hydropower-dMRV-with-5-layer-verification-](https://github.com/BikramBiswas786/Hedera-hydropower-dMRV-with-5-layer-verification-) | Version: V4.2 — ALL AUDIT FIXES APPLIED | March 24, 2026*
